...
class MagicPin:
    ...
    def __init__(
        ...
        net: Net,
        cell: Cell,
        magic_terminal: MagicTerminal,
        bounding_box: Rectangle | None = None,
    ) -> None:
        """Initialize a physical pin.
    ...
    def rotate_by(self, coordinate: tuple[float, float], angle: int):
        """Rotate the pin, counter-clockwise, around <coordinate> by angle <angle>.
