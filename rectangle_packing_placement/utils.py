...
def do_placement(
    ...
    """Perform a placement of circuit <circuit>.

    Perform a placement by using a sequence-pair representation of the placement and performing
    ...
    solution = PlacementSolver().solve(
        problem=problem,
    ...
    if fig_path:
        ...
        PlacementVisualizer().visualize(
            solution=solution, path=f"{fig_path}/{circuit.name}.png"
        )
