...
class RoutingRule(Rule, metaclass=abc.ABCMeta):
    """Abstract class for routing rules.
    ...
    @property
    def cell(self):
        """Return the cell this routing rules is attached to."""
        return self._cell


class AreaRule(RoutingRule, metaclass=abc.ABCMeta):
    """Abstract class for area rules."""
...
class LayerRule(AreaRule, metaclass=abc.ABCMeta):
    """Abstract class for layer rules."""
