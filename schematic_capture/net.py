...
class Net:
    ...
    def get_magic_terminals(self, only_primitive=False) -> dict[str, MagicTerminal]:
        ...
        for d in [device1, device2]:
            ...
            for term in d.cell.terminals_connected_to_net(self):
                ...
                try:
                    ...
                    raise ValueError("Device has no cell!") from e
    ...
    def bounding_box(self) -> tuple[float, float, float, float]:
        """Get the bounding box of the net, defined by the outermost pins.
...
def get_root_net(net: SubNet) -> Net:
    ...
    """
    if isinstance(net, SubNet):  # if the net is a subnet
