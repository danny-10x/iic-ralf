...
class Netlist:
    ...
    def _get_top_net(self):
        """Set the top netlist in self._net.
            ...
            if not in_subckt:
                ...
                if line.startswith("."):
                    ...
                    # if the command is a global statement -> raise a warning
                        ...
                        warnings.warn(
                            f"Suppressing line: {line}! .GLOBAL statements aren't supported!",
                            stacklevel=2,
                        )
                        break
                    else:
